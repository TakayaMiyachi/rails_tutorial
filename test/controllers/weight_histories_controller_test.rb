...
class WeightHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight_history" do
    assert_difference("WeightHistory.count") do
      post weight_histories_url, params: { weight_history: { memo: @weight_history.memo, user_id: @weight_history.user_id, wight: @weight_history.wight } }
    end
  ...
  test "should update weight_history" do
    patch weight_history_url(@weight_history), params: { weight_history: { memo: @weight_history.memo, user_id: @weight_history.user_id, wight: @weight_history.wight } }
